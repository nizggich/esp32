...
extern "C"
{
    ...
    typedef struct
    {
        ...
        spi_host_device_t spi_bus;  /*!< SPI bus ID. Which buses are available
     ...
     * @note Although only the MOSI line is used for generating the signal, the
     * whole SPI bus can't be used for other purposes.
     *
     ...
     * invalid argument
     *      - ESP_ERR_NOT_SUPPORTED: create LED strip handle failed because of
