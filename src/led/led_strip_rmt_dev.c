...
static esp_err_t led_strip_rmt_set_pixel(led_strip_t *strip, uint32_t index, uint32_t red,
...
static esp_err_t led_strip_rmt_set_pixel_rgbw(led_strip_t *strip, uint32_t index, uint32_t red,
...
static esp_err_t led_strip_rmt_refresh(led_strip_t *strip)
{
    ...
    ESP_RETURN_ON_ERROR(rmt_transmit(rmt_strip->rmt_chan, rmt_strip->strip_encoder,
                                     rmt_strip->pixel_buf,
                                   ...
                                   led_strip_handle_t *ret_strip)
{
    ...
    ESP_GOTO_ON_FALSE(led_config && rmt_config && ret_strip, ESP_ERR_INVALID_ARG, err, TAG,
                      "invalid argument");
    ...
    uint32_t resolution =
        rmt_config->resolution_hz ? rmt_config->resolution_hz : LED_STRIP_RMT_DEFAULT_RESOLUTION;
    ...
    ESP_GOTO_ON_ERROR(rmt_new_tx_channel(&rmt_chan_config, &rmt_strip->rmt_chan), err, TAG,
                      "create RMT TX channel failed");

    led_strip_encoder_config_t strip_encoder_conf = {.resolution = resolution,
                                                     .led_model = led_config->led_model};
    ESP_GOTO_ON_ERROR(rmt_new_led_strip_encoder(&strip_encoder_conf, &rmt_strip->strip_encoder),
